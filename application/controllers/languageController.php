...
class languageController extends Controller{
	 ...
	 */
    function index(){
		$this->action_index(new Language(),true);
    }
	 ...
	 */
    function create(){
		$this->action_create(new Language(),$_POST,true);
    }
	 ...
	 */
    function edit($id){
		$this->action_edit($id,new Language(),$_POST,true);
    }
    ...
    public function delete($id){
		$this->action_delete($id,new Language());
	}
}
?>