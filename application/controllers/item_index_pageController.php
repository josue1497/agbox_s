 ...
 */
class item_index_pageController extends Controller{
	/**
	 ...
	 */
    function index(){
		$this->action_index(new Item_Index_Page(),true);
    }
	 ...
	 */
    function create(){
		$this->action_create(new Item_Index_Page(),$_POST,true);
    }
	 ...
	 */
    function edit($id){
		$this->action_edit($id,new Item_Index_Page(),$_POST,true);
    }
    ...
    public function delete($id){
		$this->action_delete($id,new Item_Index_Page());
	}
}
?>