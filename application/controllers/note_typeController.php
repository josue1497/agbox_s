...
class note_typeController extends Controller{
	 ...
	 */
    function index(){
		$this->action_index(new Note_Type(),true);
    }
	 ...
	 */
    function create(){
		$this->action_create(new Note_Type(),$_POST,true);
    }
	 ...
	 */
    function edit($id){
		$this->action_edit($id,new Note_Type(),$_POST,true);
    }
    ...
    public function delete($id){
		$this->action_delete($id,new Note_Type());
	}
}
?>