...
function generate_content($controller, $filename = null, $record = null)
{
    ...
    $controller->model->hide_form_column('user_id');

    $form_params = $controller->view->auto_build_form_content($record, false);

    $form_params .= ' <div class="d-flex flex-row justify-content-center">
    ...
    $title_setting = '<div class="d-flex align-items-center">Parametros de la Aplicación
    <button class="btn btn-info ml-auto" data-toggle="popover" title="Ayuda" 
            data-content="En este apartado usted podra seleccionar<br>
            las configuraciones que tendra la aplicacion durante su uso<br>
            como por ejemplo:<br>
            El idioma, la zona horaria, el formato de fecha a mostrar" data-trigger="focus" data-html="true">
        <i class="fas fa-question text-white"></i>
    </button>
    </div>';
    ...
    $html_result = str_replace('{{ PARAMS_APP }}', CoreUtils::add_new_card($form_params, $title_setting), $html_result);
